...
async function resolveReferenceYear(params: {
  ...
  const [benchmarkSubmission, filingRecord, latestReading] = await Promise.all([
  ...
  if (filingRecord?.filingYear != null) {
    return filingRecord.filingYear - 1;
  }
