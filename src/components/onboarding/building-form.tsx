...
export function BuildingForm({ onSubmit, loading }: BuildingFormProps) {
 ...
 const inputClass =
 "mt-1.5 block w-full border border-zinc-200 px-4 py-3 text-base text-zinc-900 placeholder:text-zinc-400 transition-shadow focus:border-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-900/10";
 const labelClass = "block text-sm font-semibold tracking-wide text-zinc-700";
