  ...
  return (
    <div className="space-y-8 text-center py-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-[15px] font-medium text-zinc-500 leading-relaxed max-w-sm mx-auto">
      ...
      <div className="space-y-4 pt-4">
        <Link
          href="/dashboard"
          className="block w-full rounded-lg bg-zinc-900 px-4 py-3 text-center text-[15px] font-semibold text-white shadow-md hover:bg-zinc-800 transition-all active:scale-[0.98]"
        >
          Go to dashboard
        </Link>
        <Link
          href="/dashboard"
          className="block text-[13px] font-medium text-zinc-500 hover:text-zinc-800 transition-colors"
        >
