...
export function StepConnect({ onNext, onSkip }: StepConnectProps) {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-xl font-semibold tracking-tight text-slate-900">Connect ENERGY STAR Portfolio Manager</h2>
      ...
      <div className="rounded-xl border border-slate-200/80 bg-slate-50/50 p-6 space-y-4">
        <h3 className="text-[15px] font-semibold tracking-tight text-slate-900">How it works</h3>
        <ol className="list-decimal list-inside space-y-2 text-[15px] font-medium text-slate-600 leading-relaxed">
      ...
      <div className="rounded-lg bg-slate-100/50 p-4 border border-slate-200/50">
