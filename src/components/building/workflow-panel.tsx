...
export function WorkflowPanel({ nextAction, stages }: WorkflowPanelProps) {
 ...
 className="inline-flex shrink-0 items-center rounded-md border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50 hover:text-zinc-900"
 >
 Open step
 </Link>
 </div>
...
function WorkflowStageCard({
 ...
 <Link
 href={stage.href}
 className="text-sm font-medium text-zinc-700 underline decoration-zinc-300 underline-offset-4 transition-colors hover:text-zinc-900"
 >
