...
>
 ...
 return (
 <div key={item.id} className="border border-zinc-200 p-4">
 ...
 {item.notes ? (
 <p className="mt-3 text-sm leading-relaxed text-zinc-700">{item.notes}</p>
 ) : null}
 </div>
 );
 })}
 ...
 <div
 key={packet.id}
 className="flex flex-wrap items-center justify-between gap-3 border border-zinc-200 p-4"
 >
 <div>
