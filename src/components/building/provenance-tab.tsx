    ...
    <div className="space-y-6">
      ...
      <Panel title="Compliance Runs" subtitle="Governed calculation runs and manifests for this building.">
        {!runs.data || runs.data.length === 0 ? (
          ...
          <div className="space-y-3">
            {runs.data.map((run) => (
              <div key={run.id} className="rounded border border-zinc-200 px-3 py-3">
          ...
          {!submissions.data || submissions.data.length === 0 ? (
            ...
            <div className="space-y-3">
              {submissions.data.map((submission) => (
                <div key={submission.id} className="rounded border border-zinc-200 px-3 py-3">
          ...
          {!filings.data || filings.data.length === 0 ? (
            ...
            <div className="space-y-3">
              {filings.data.map((filing) => (
                <div key={filing.id} className="rounded border border-zinc-200 px-3 py-3">
                  <div className="font-medium text-zinc-900">
