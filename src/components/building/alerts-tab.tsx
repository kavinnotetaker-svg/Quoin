              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    {alert.aiRootCause && (
                      <div className="mt-3 rounded-lg bg-white/60 border border-blue-100/50 p-3 shadow-sm backdrop-blur-sm">
                        <p className="text-[11px] font-bold uppercase tracking-wider text-blue-800">AI Root Cause Analysis</p>
                        <p className="mt-1 text-sm text-blue-900 leading-relaxed">{alert.aiRootCause}</p>
                      </div>
                    )}
                  ...
                  {alert.status === "ACTIVE" && (
                    <div className="flex flex-row sm:flex-col gap-2 w-full sm:w-auto mt-2 sm:mt-0">
                      ...
                      <button
                        ...
                        className="flex-1 sm:flex-none rounded-md bg-white px-3 py-1.5 text-[13px] font-medium text-emerald-700 shadow-sm ring-1 ring-inset ring-emerald-200 hover:bg-emerald-50 transition-colors disabled:opacity-50"
                      >
                        Resolve
                      </button>
                    </div>
