...
export function PortfolioInsights({
 ...
 className="card-machined p-4 transition-all hover: hover:border-zinc-300"
 >
 ...
 return (
 <div key={entry.buildingId} className="card-machined p-4 transition-all hover: hover:border-zinc-300">
 <div className="flex items-center justify-between gap-3">
 ...
 <p className="mt-1 text-sm text-zinc-500">{entry.nextAction.title}</p>
 <p className="mt-1 text-sm text-zinc-500">{entry.nextAction.reason}</p>
 </div>
 );
 })}
 </div>
 ...
 <div key={anomaly.id} className="card-machined p-4 transition-all hover: hover:border-zinc-300">
 <div className="flex items-center justify-between gap-3">
 ...
 <p className="mt-1 text-sm text-zinc-500">{anomaly.anomalyType}</p>
 </div>
 ))}
 </div>
 )}
 ...
 <div key={candidate.candidateId} className="card-machined p-4 transition-all hover: hover:border-zinc-300">
