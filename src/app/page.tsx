  ...
  return (
    <div className="flex min-h-screen flex-col bg-zinc-50 selection:bg-zinc-200 overflow-hidden relative">
      ...
      <div className="absolute top-0 inset-x-0 h-[500px] flex justify-center overflow-hidden pointer-events-none">
        <div className="w-[1000px] h-[500px] bg-gradient-to-b from-zinc-200/50 to-transparent blur-3xl opacity-50 rounded-full -translate-y-1/2" />
      </div>
      ...
      <header className="flex h-16 w-full items-center justify-between border-b border-zinc-200/80 bg-white/70 px-6 backdrop-blur-xl sticky top-0 z-50 transition-all">
        ...
        <div className="flex items-center gap-5">
          ...
          <Link
            href="/sign-up"
            className="rounded-full bg-zinc-900 px-5 py-2.5 text-[14px] font-semibold text-white shadow-sm transition-all hover:bg-zinc-800 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0"
          >
            Get started
          </Link>
        </div>
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 text-center py-24 sm:py-32 z-10">
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out fill-mode-both max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl font-extrabold tracking-tight text-zinc-900 sm:text-7xl leading-[1.1] selection:bg-zinc-200">
            DC BEPS compliance, <br className="hidden sm:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-500 to-zinc-800">automated</span>.
          </h1>
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/sign-up"
              className="w-full sm:w-auto rounded-full bg-zinc-900 px-8 py-4 text-[15px] font-semibold text-white shadow-lg transition-all hover:bg-zinc-800 hover:shadow-xl hover:-translate-y-1 active:scale-[0.98] active:translate-y-0 flex items-center justify-center gap-2"
            >
              Start free trial
            ...
            <Link
              href="/sign-in"
              className="w-full sm:w-auto rounded-full border border-zinc-200/80 bg-white/50 backdrop-blur-sm px-8 py-4 text-[15px] font-semibold text-zinc-900 shadow-sm transition-all hover:bg-white hover:border-zinc-300 hover:shadow-md active:scale-[0.98]"
            >
              Sign in
            </Link>
          </div>
        ...
        <div className="mt-32 grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3 mx-auto z-10">
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 ease-out fill-mode-both rounded-3xl border border-zinc-200/80 bg-white/80 p-8 shadow-sm text-left transition-all hover:shadow-xl hover:-translate-y-2 group">
            <div className="h-12 w-12 rounded-xl bg-zinc-50 flex items-center justify-center mb-6 border border-zinc-200/80 shadow-sm group-hover:scale-110 transition-transform">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 ease-out fill-mode-both rounded-3xl border border-zinc-200/80 bg-white/80 p-8 shadow-sm text-left transition-all hover:shadow-xl hover:-translate-y-2 group relative overflow-hidden">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-700 ease-out fill-mode-both rounded-3xl border border-zinc-200/80 bg-white/80 p-8 shadow-sm text-left transition-all hover:shadow-xl hover:-translate-y-2 group">
            <div className="h-12 w-12 rounded-xl bg-zinc-50 flex items-center justify-center mb-6 border border-zinc-200/80 shadow-sm group-hover:scale-110 transition-transform">
              <span className="text-xl">💰</span>
            </div>
