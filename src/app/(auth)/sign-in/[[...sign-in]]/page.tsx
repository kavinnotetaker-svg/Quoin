    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 p-4 selection:bg-zinc-200">
      <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <SignIn 
          appearance={{
            elements: {
              formButtonPrimary: 'bg-zinc-900 hover:bg-zinc-800 text-sm normal-case shadow-sm transition-all',
              card: 'shadow-xl shadow-zinc-200/50 rounded-2xl border border-zinc-200 w-full',
              headerTitle: 'hidden',
